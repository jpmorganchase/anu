...
import {HemisphericLight, Vector3, Scene, ArcRotateCamera, StandardMaterial, Color3, Color4, PointerEventTypes, GPUPicker } from '@babylonjs/core'; 
import { AdvancedDynamicTexture, Rectangle, TextBlock} from '@babylonjs/gui';
import {extent, scaleOrdinal, scaleLinear, map,} from "d3";
import tsne from '../../data/mnist_tsne.csv';
