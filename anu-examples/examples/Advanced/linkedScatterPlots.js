...
import cars from 'anu/../../data/cars.json';

export function linkedScatterPlots(babylonEngine){

  //Babylon boilerplate
  const scene = new BABYLON.Scene(babylonEngine);
  const light = new BABYLON.HemisphericLight('light1', new BABYLON.Vector3(0, 10, -10), scene)
  const camera = new BABYLON.ArcRotateCamera("Camera", -(Math.PI / 4), Math.PI / 2.25, 8, new BABYLON.Vector3(0, -0.5, 2), scene);
  ...
  function createScatterPlot(id) {
    ...
    axesOptions.labelProperties = { size : 0.2 };
