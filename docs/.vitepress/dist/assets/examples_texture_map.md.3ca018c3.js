import{_ as n,o as s,c as a,O as l}from"./chunks/framework.eb48dd0f.js";const D=JSON.parse('{"title":"Texture Map","description":"","frontmatter":{"aside":false},"headers":[],"relativePath":"examples/texture_map.md","filePath":"examples/texture_map.md"}'),p={name:"examples/texture_map.md"},e=l(`<h1 id="texture-map" tabindex="-1">Texture Map <a class="header-anchor" href="#texture-map" aria-label="Permalink to &quot;Texture Map&quot;">​</a></h1><div style="width:100%;"><iframe id="inlineFrameExample" title="Inline Frame Example" src="/examples.html?example=textureMap">
    </iframe></div><div class="vp-code-group"><div class="tabs"><input type="radio" name="group-kGsBY" id="tab-qVV6nDI" checked="checked"><label for="tab-qVV6nDI">texture_Map.js</label><input type="radio" name="group-kGsBY" id="tab-3VAYmKb"><label for="tab-3VAYmKb">airports.csv</label></div><div class="blocks"><div class="language-js active"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// SPDX-License-Identifier: Apache-2.0</span></span>
