import{_ as n,o as s,c as a,O as l}from"./chunks/framework.dacf182e.js";const D=JSON.parse('{"title":"Texture Globe","description":"","frontmatter":{"aside":false},"headers":[],"relativePath":"examples/texture_globe.md","filePath":"examples/texture_globe.md"}'),p={name:"examples/texture_globe.md"},e=l(`<h1 id="texture-globe" tabindex="-1">Texture Globe <a class="header-anchor" href="#texture-globe" aria-label="Permalink to &quot;Texture Globe&quot;">​</a></h1><div style="width:100%;"><iframe id="inlineFrameExample" title="Inline Frame Example" src="/examples.html?example=textureGlobe">
    </iframe></div><div class="vp-code-group"><div class="tabs"><input type="radio" name="group-WpN0E" id="tab-bmBPGOd" checked="checked"><label for="tab-bmBPGOd">texture_Globe.js</label><input type="radio" name="group-WpN0E" id="tab-QxJ4oH4"><label for="tab-QxJ4oH4">airports.csv</label></div><div class="blocks"><div class="language-js active"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// SPDX-License-Identifier: Apache-2.0</span></span>
