import{_ as s,o as a,c as l,z as n,a as p,O as e}from"./chunks/framework.dacf182e.js";const d=JSON.parse('{"title":"Texture Globe","description":"","frontmatter":{"aside":false},"headers":[],"relativePath":"examples/texture_globe.md","filePath":"examples/texture_globe.md"}'),o={name:"examples/texture_globe.md"},A=n("h1",{id:"texture-globe",tabindex:"-1"},[p("Texture Globe "),n("a",{class:"header-anchor",href:"#texture-globe","aria-label":'Permalink to "Texture Globe"'},"​")],-1),i=n("div",{style:{width:"100%"}},[n("iframe",{id:"inlineFrameExample",allow:"xr-spatial-tracking",allowfullscreen:"",title:"Inline Frame Example",src:"/anu/examples.html?example=textureGlobe"},`
    `)],-1),C=e(`<div class="vp-code-group"><div class="tabs"><input type="radio" name="group-xwKmD" id="tab-n0UpAeS" checked="checked"><label for="tab-n0UpAeS">Texture_Globe.js</label><input type="radio" name="group-xwKmD" id="tab-8uQMwdT"><label for="tab-8uQMwdT">airports.csv</label></div><div class="blocks"><div class="language-js active"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// SPDX-License-Identifier: Apache-2.0</span></span>
