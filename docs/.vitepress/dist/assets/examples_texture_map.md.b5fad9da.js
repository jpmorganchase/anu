import{_ as s,o as a,c as l,z as n,a as p,O as e}from"./chunks/framework.dacf182e.js";const d=JSON.parse('{"title":"Texture Map","description":"","frontmatter":{"aside":false},"headers":[],"relativePath":"examples/texture_map.md","filePath":"examples/texture_map.md"}'),o={name:"examples/texture_map.md"},A=n("h1",{id:"texture-map",tabindex:"-1"},[p("Texture Map "),n("a",{class:"header-anchor",href:"#texture-map","aria-label":'Permalink to "Texture Map"'},"​")],-1),i=n("div",{style:{width:"100%"}},[n("iframe",{id:"inlineFrameExample",allow:"xr-spatial-tracking",allowfullscreen:"",title:"Inline Frame Example",src:"/anu/examples.html?example=textureMap"},`
    `)],-1),c=e(`<div class="vp-code-group"><div class="tabs"><input type="radio" name="group-irwt5" id="tab-D_PvOEw" checked="checked"><label for="tab-D_PvOEw">Texture_Map.js</label><input type="radio" name="group-irwt5" id="tab-9dbMk1m"><label for="tab-9dbMk1m">airports.csv</label></div><div class="blocks"><div class="language-js active"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// SPDX-License-Identifier: Apache-2.0</span></span>
...
<span class="line"><span style="color:#A6ACCD;">ZZV,Zanesville Municipal,Zanesville,OH,USA,39.94445833,-81.89210528</span></span></code></pre></div></div></div>`,1),C=[A,i,c];function r(t,y,S,D,U,u){return a(),l("div",null,C)}const F=s(o,[["render",r]]);export{d as __pageData,F as default};
