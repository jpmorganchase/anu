# Hello Box
Let's start with the absolute basics, adding a box mesh to our scene, and manipulating its initializing parameters with some data. 
...
:::
  <iframe id="inlineFrameExample"
      ...
      width="100%"
      height="400"
      src="/index.html/?example=box_data">
  </iframe>
...
:::
  <iframe id="inlineFrameExample"
      ...
      width="100%"
      height="400"
      src="/index.html/?example=box_bind">
  </iframe>
...
:::
  <iframe id="inlineFrameExample"
      ...
      width="100%"
      height="400"
      src="/index.html/?example=box_selection">
  </iframe>
