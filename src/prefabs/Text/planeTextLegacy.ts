...
export class PlaneTextLegacy extends Mesh {
  name: string;
  scene: Scene;
 ...
 */
export function createPlaneTextLegacy(name: string, options: PlaneTextOptions, scene: Scene) {
  const ops = {
  ...
  let plane = new PlaneTextLegacy(name, ops, scene);
  return plane;
}