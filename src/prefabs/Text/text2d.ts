...
import { DynamicTexture, StandardMaterial, MeshBuilder, Mesh, AbstractMesh, TransformNode, Scene } from '@babylonjs/core';
...
class Text2D {
  ...
  //   text: `Test`,
  //   font: this.options.fnt,
  //   scene: this.scene,
  //   atlas: this.options.png,
...
export function planeText(
  ...
  const ops = {
    ...
    fontMod: options.fontMod || '',
    fontStyle: options.fontStyle || 'Arial',
